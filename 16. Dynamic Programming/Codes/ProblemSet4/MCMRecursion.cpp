...
Consider matrix A[2*3], B[3*5], then C will be [2*5]
now if we have to fill matrix C, it has 2*5 spots to be filled and to fill each spot we require 3 operatations (dry run on page to understand better)
hence we require total of 2*5*3 operations to fill the matrix
